 ...
 */
export const getGetExamOverviewUrl = () => {
  return `/api/prepmind/overview`;
};
...
export const getExamOverview = async (
  ...
  return customFetch<unknown>(getGetExamOverviewUrl(), {
    ...options,
    method: "POST",
...
export const getGetExamOverviewMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof getExamOverview>>,
    TError,
    { data: BodyType<ExamRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["getExamOverview"];
  ...
  > = (props) => {
    ...
    return getExamOverview(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type GetExamOverviewMutationResult = NonNullable<
  Awaited<ReturnType<typeof getExamOverview>>
>;
export type GetExamOverviewMutationBody = BodyType<ExamRequest>;
export type GetExamOverviewMutationError = ErrorType<unknown>;

/**
 * @summary Get exam overview, syllabus, pattern, strategy
 */
export const useGetExamOverview = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getGetExamOverviewMutationOptions(options));
};

/**
 * @summary Generate MCQ practice questions for a topic
 */
export const getGeneratePracticeQuestionsUrl = () => {
  return `/api/prepmind/practice`;
};
...
export const generatePracticeQuestions = async (
  ...
  return customFetch<PracticeResponse>(getGeneratePracticeQuestionsUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
export const getGeneratePracticeQuestionsMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return generatePracticeQuestions(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type GeneratePracticeQuestionsMutationResult = NonNullable<
  Awaited<ReturnType<typeof generatePracticeQuestions>>
>;
export type GeneratePracticeQuestionsMutationBody = BodyType<PracticeRequest>;
export type GeneratePracticeQuestionsMutationError = ErrorType<unknown>;

/**
 * @summary Generate MCQ practice questions for a topic
 */
export const useGeneratePracticeQuestions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
 ...
 */
export const getTeachTopicUrl = () => {
  return `/api/prepmind/teach`;
};

export const teachTopic = async (
  teachRequest: TeachRequest,
  options?: RequestInit,
): Promise<unknown> => {
  return customFetch<unknown>(getTeachTopicUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(teachRequest),
  });
};

export const getTeachTopicMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof teachTopic>>,
    TError,
    { data: BodyType<TeachRequest> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
...
> => {
  ...
  > = (props) => {
    ...
    return teachTopic(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type TeachTopicMutationResult = NonNullable<
  Awaited<ReturnType<typeof teachTopic>>
>;
export type TeachTopicMutationBody = BodyType<TeachRequest>;
export type TeachTopicMutationError = ErrorType<unknown>;

/**
 * @summary Teach a specific topic with explanations, formulas, shortcuts
 */
export const useTeachTopic = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getTeachTopicMutationOptions(options));
};
